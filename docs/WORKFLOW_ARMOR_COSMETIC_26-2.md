...
> Este archivo pertenece al proyecto **Armor Cosmetic**. Cambios aquí solo afectan a este proyecto.
...
| Dato | Valor |
|---|---|
| Mod ID (`gradle.properties`) | `armor_cosmetic` |
| Clase principal | `ArmorCosmetic` |
| Display name (Title Case) | `Armor Cosmetic` |
...
|---|---|---|
| **snake_case** | `mod_id`, assets/, packages Java | `armor_cosmetic` |
| **PascalCase** | Clases Java principales | `ArmorCosmetic` |
| **camelCase** | Variables, métodos, config keys | `armor_cosmeticConfig` |
| **Title Case** | Display name (README, CHANGELOG, docs, CurseForge) | `Armor Cosmetic` |
