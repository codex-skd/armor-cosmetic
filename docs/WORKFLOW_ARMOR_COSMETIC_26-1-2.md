...
|---|---|---|
| WORKFLOW | `WORKFLOW_<MOD_ID>_<MC-VERSION>.md` | `WORKFLOW_ARMOR_COSMETIC_26-1-2.md` |
...
| Ejemplo | Significado |
|---|---|
| `armor_cosmetic-26.1.2-neoforge-1.0.21.jar` | NeoForge 26.1.2, v1.0.21 |
...
#    cp build/libs/armor_cosmetic-26.1.2-neoforge-<version>.jar /ruta/a/la/instancia/mods/
#    rm /ruta/a/la/instancia/mods/armor_cosmetic-26.1.2-neoforge-<version-anterior>.jar
```
...
git tag -a 26.1.2-neoforge-1.0.22 -m "v1.0.22: Bugfix release"
git push origin 26.1.2-neoforge-1.0.22

# 8. PREGUNTAR: "¿Subir JAR a CurseForge ahora?"
#    Solo subir si el usuario confirma.
#    El JAR está en build/libs/armor_cosmetic-26.1.2-neoforge-<version>.jar
