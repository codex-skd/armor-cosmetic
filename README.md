...
- **Corail Tombstone compatible**: With Tombstone installed, cosmetic gear stays in its cosmetic slots on death (since 1.0.1), so it isn't lost or turned into real armor.
...
The JAR is generated at `build/libs/armor_cosmetic-1.21.1-neoforge-21.1.249-<version>.jar`.
